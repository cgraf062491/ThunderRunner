...
public class CloudCrafterTwo : MonoBehaviour {
	...
	void Update () {
		...
		//cloudPosMin.x = Player.transform.position.x - 40;
		//cloudPosMax.x = Player.transform.position.x + 40;
		//cloudPosMin.y = Player.transform.position.y - 20;
		//cloudPosMax.y = Player.transform.position.y + 20;
